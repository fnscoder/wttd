...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expect = ['john@lennon.com', 'contato@eventex.com']
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('John Lennon', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('john@lennon.com', email.body)
        self.assertIn('12-3456-7890', email.body)
